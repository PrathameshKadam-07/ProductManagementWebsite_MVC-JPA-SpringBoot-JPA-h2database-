...
<div class="col-md-3 col-lg-2 sidebar">
    ...
    <a href="Showall">📦 Show All Products</a>
            ...
            <!-- Main Content -->
            <div class="col-md-9 col-lg-10 p-4 d-flex justify-content-center align-items-center">
                <div class="card shadow-lg p-4 animate__animated animate__fadeIn w-100">
                    <h3 class="text-center mb-4 fw-semibold">Update Product</h3>
                    ...
                    <form action="update" method="post">
                        ...
                        <div class="mb-3">
                            <input type="text" name="pname" class="form-control" placeholder="New Name">
                        </div>
                        <div class="mb-3">
                            <input type="number" name="qty" class="form-control" placeholder="New Quantity">
                        </div>
                        <div class="mb-3">
                        ...
                        <button type="submit" class="btn btn-warning w-100 btn-custom">Update</button>
                    </form>
